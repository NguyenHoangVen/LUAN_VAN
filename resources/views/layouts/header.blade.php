    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 d-flex justify-content-between">
                <!-- <div id="logo"> -->
                <a href="{{url('home')}}" title="" class="d-block" id="logo"><img src="image/logo/logophuot.png"
                        alt=""></a>
                <!-- </div> -->
                ...
                <div class="user-login">
                    <!-- user chua dang nhap -->
                    @if(!Auth::check())
                    <div class="not-loged-in"><a href="{{url('login')}}" title="" class="btn btn-danger"><i
                                class="fas fa-sign-in-alt"></i> Đăng Nhập</a></div>
                    @else
                    <!-- user da dang nhap -->
                    <div class="loged-in">
                        <div class=" d-flex justify-content-between">
                            <!-- Notification -->
                            <div class="nav-item dropdown pt-2 notification">
                            	<input type="hidden" class="user_id_login" value="{{Auth::user()->id}}">
                                <a class="nav-link" data-toggle="dropdown" href="#" aria-expanded="true">
                                    <i class="far fa-bell"></i>
                                    <span class="badge badge-danger navbar-badge"></span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right dropdown-notification"
