...
<style>
    ...
    #result_derection h5{font-size: 15px;font-weight: bold}
  ...
  // ==== Noi cua fpt===
  	...
  	function initMap() {
    	var map = new google.maps.Map(document.getElementById('map'), {
      		...
      		center: {lat: 9.986480, lng: 105.779736},
      		zoom: 13
    	});
  	...
  	this.directionsService.route(
        ...
        if (status === 'OK') {
          	...
          	for (var i = 0; i < routes.length; i++) {
	            ...
	            var stepsCoords = [];
	            var voice = 'Xin chao bạn Vẹn. Mình sẽ chỉ bạn đường đi từ '+routes[i].legs[0].start_address+' đến'+routes[i].legs[0].end_address+' là, đầu tiên bạn ';

	            result += '<div class="item mt-1"><div class="btn btn-info w-100" data-toggle="collapse" data-target="#street'+i+'">'+routes[i].summary+'('+routes[i].legs[0].distance.text+')'+'</div>'
	                ...
	                +'<audio class="d-none" controls="" id="voice-audio-'+i+'" autoplay="" src=""></audio>'
